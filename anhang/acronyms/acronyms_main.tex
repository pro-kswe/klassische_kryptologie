...
\begin{multicols}{2}
\begin{acronym}
\acro{IDE}{Integrated Development Environment \acroextra{(dt. integrierte Entwicklungsumgebung)}}
\acro{RAM}{Random Access Memory \acroextra{(dt. Direktzugriffsspeicher)}}
...
\acro{CCD}{Charge-Coupled Device \acroextra{(dt. ladungsgekoppeltes Bauteil)}}
\acro{BCD}{Binary Coded Decimal \acroextra{(dt. binärcodierte Dezimalziffer)}}
